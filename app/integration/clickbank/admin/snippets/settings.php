...
Ucontext_Form::textField('uContext API Key', 'form_vars[ucontext_api_key]', @get_option('ucontext_api_key'), NULL, 'Your uContext API Key from the <a href="https://uContext.com/members" target="_blank">members area...</a>', TRUE);
...
<tr>
	...
	<td>
		<input type="button" value="Import Now" onclick="window.location.href='admin.php?page=ucontext&action=import_settings'" />
		<p>Click this button to import settings and filters from the previous plug-in version.</p>
	</td>
</tr>
<?php
	}
...
<tr>
	<th>Import Logs:</th>
	<td>
		<input type="button" value="Import Now" onclick="window.location.href='admin.php?page=ucontext&action=import_logs'" />
